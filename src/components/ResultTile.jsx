...
const ResultTile = ({ img, name, releaseDate }) => {
    return (
        <button className="h-25 p-2 w-full rounded bg-neutral-950 flex items-center gap-2.5 cursor-pointer hover:scale-102 transition-all hover:bg-rose-500">
            {/* //* Image*/}
            <img
